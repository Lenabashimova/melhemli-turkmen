...
export default function Footer(){
    ...
    return(
        <>
            <section id="footer" className="py-12.5 px-12.5 bg-[#0C233E] lg:px-25 lg:py-25">
                    ...
                    <div className="flex flex-col lg:gap-25 gap-7">
                        ...
                        <div className="lg:flex justify-between items-end">
                            <div className="flex-col mb-48 lg:mb-0">
                                ...
                                <button className="bg-white rounded-3xl text-[14px] text-[#0C233E] lg:text-[#A9A9A9] py-2 px-9 cursor-pointer lg:text-[20px] hover:bg-[#B42226] hover:text-white">{t.footer.button}</button>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <nav className="flex flex-col gap-3 text-[14px] lg:text-[20px] font-thin">
                                    <Link href={'#'} className='hover:text-[#B42226]'>{t.footer.instagram}</Link>
                                    <Link href={'#'} className='hover:text-[#B42226]'>{t.footer.facebook}</Link>
                                    <Link href={'#'} className='hover:text-[#B42226]'>{t.footer.tiktok}</Link>
                                </nav>
                            </div>
                        </div>
                            <div className="flex flex-col gap-4">
                                ...
                                <nav className="flex flex-col gap-3 text-[14px] lg:text-[20px] font-thin">
                                    <Link href={'#'} className='hover:text-[#B42226]'>{t.footer.privacy}</Link>
                                    <Link href={'#'} className='hover:text-[#B42226]'>{t.footer.copyrights}</Link>
                                    <Link href={'#'} className='hover:text-[#B42226]'>{t.footer.userAgreements}</Link>
                                </nav>
                            </div>
                            </div>
                    </div>  
